        ...
        <div class="col-12 lg:col-6">
            <div class="card p-fluid">
                ...
                <Dialog header="Dialog" v-model:visible="display" :breakpoints="{ '960px': '75vw' }" :style="{ width: '30vw' }" :modal="true">
                    ...
                    <template #footer>
                        <Button label="Ok" @click="close" icon="pi pi-check" outlined />
                    </template>
                </Dialog>
            ...
            <div class="card p-fluid">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <div>
                        ...
                        <OverlayPanel ref="op2" :showCloseIcon="true" id="overlay_panel" style="width: 450px">
            ...
            <div class="card p-fluid">
                ...
                <Dialog header="Confirmation" v-model:visible="displayConfirmation" :style="{ width: '350px' }" :modal="true">
                    ...
                    <template #footer>
                        ...
                        <Button label="Yes" icon="pi pi-check" @click="closeConfirmation" text autofocus />
                    </template>
                </Dialog>
            </div>
            <div class="card">
                ...
                <Button icon="pi pi-arrow-right" severity="warning" @click="visibleLeft = true" style="margin-right: 0.25em" />
                <Button icon="pi pi-arrow-left" severity="warning" @click="visibleRight = true" style="margin-right: 0.25em" />
                <Button icon="pi pi-arrow-down" severity="warning" @click="visibleTop = true" style="margin-right: 0.25em" />
                <Button icon="pi pi-arrow-up" severity="warning" @click="visibleBottom = true" style="margin-right: 0.25em" />
