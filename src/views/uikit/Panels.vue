            ...
            <div class="card">
                ...
                <Toolbar>
                    <template v-slot:start>
                        ...
                        <Button label="Open" icon="pi pi-folder-open" class="mr-2" severity="secondary" />

                        <i class="pi pi-bars p-toolbar-separator mr-2"></i>

                        <Button icon="pi pi-check" class="mr-2" severity="success" />
                        <Button icon="pi pi-trash" class="mr-2" severity="warning" />
            ...
            <div class="card">
                ...
                <Splitter style="height: 300px" class="mb-5">
                    <SplitterPanel :size="30" :minSize="10">
                        <div class="h-full flex align-items-center justify-content-center">Panel 1</div>
                    </SplitterPanel>
                    <SplitterPanel :size="70">
                        <Splitter layout="vertical">
                            <SplitterPanel :size="15">
                                <div class="h-full flex align-items-center justify-content-center">Panel 2</div>
                            </SplitterPanel>
                            <SplitterPanel :size="50">
                                <div class="h-full flex align-items-center justify-content-center">Panel 3</div>
                            </SplitterPanel>
                        </Splitter>
                    </SplitterPanel>
                </Splitter>
