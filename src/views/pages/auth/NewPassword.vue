        ...
        <div class="border-1 surface-border surface-card border-round py-7 px-4 md:px-7 z-1">
            ...
            <div class="flex flex-column">
                <IconField iconPosition="left" class="w-full mb-4">
                    ...
                    <Password id="password1" placeholder="Password" v-model="value1" class="w-full" :inputStyle="{ paddingLeft: '2.5rem' }" inputClass="w-full md:w-25rem" toggleMask></Password>
                </IconField>
                <IconField iconPosition="left" class="w-full mb-4">
                    <InputIcon class="pi pi-lock z-2" />
                    <Password id="password2" placeholder="Repeat Password" v-model="value2" class="w-full" :inputStyle="{ paddingLeft: '2.5rem' }" inputClass="w-full md:w-25rem" toggleMask :feedback="false"></Password>
                </IconField>
