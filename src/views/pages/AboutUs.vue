        ...
        <div class="mt-3 md:mt-8">
            ...
            <div class="grid">
                <div class="col-12 md:col-6 lg:col-3 p-3">
                    <div class="relative overflow-hidden" @mouseenter="setVisibleMember(0)" @mouseleave="setVisibleMember(-1)">
                        <img src="/demo/images/blocks/team/team-1.png" class="w-full block" alt="Team 1" />

                        <div v-if="visibleMember === 0" class="absolute top-0 left-0 h-full w-full border-round fadein animation-duration-300 select-none" :style="{ backgroundColor: 'rgba(0,0,0,0.7)' }">
                ...
                <div class="col-12 md:col-6 lg:col-3 p-3">
                    <div class="relative overflow-hidden" @mouseenter="setVisibleMember(1)" @mouseleave="setVisibleMember(-1)">
                        <img src="/demo/images/blocks/team/team-2.png" class="w-full block" alt="Team 2" />

                        <div v-if="visibleMember === 1" class="absolute top-0 left-0 h-full w-full border-round fadein animation-duration-300 select-none" :style="{ backgroundColor: 'rgba(0,0,0,0.7)' }">
                            <div class="flex flex-column p-5 h-full">
                ...
                <div class="col-12 md:col-6 lg:col-3 p-3">
                    <div class="relative overflow-hidden" @mouseenter="setVisibleMember(2)" @mouseleave="setVisibleMember(-1)">
                        <img src="/demo/images/blocks/team/team-3.png" class="w-full block" alt="Team 3" />

                        <div v-if="visibleMember === 2" class="absolute top-0 left-0 h-full w-full border-round fadein animation-duration-300 select-none" :style="{ backgroundColor: 'rgba(0,0,0,0.7)' }">
                            <div class="flex flex-column p-5 h-full">
                ...
                <div class="col-12 md:col-6 lg:col-3 p-3">
                    <div class="relative overflow-hidden" @mouseenter="setVisibleMember(3)" @mouseleave="setVisibleMember(-1)">
                        <img src="/demo/images/blocks/team/team-4.png" class="w-full block" alt="Team 4" />

                        <div v-if="visibleMember === 3" class="absolute top-0 left-0 h-full w-full border-round fadein animation-duration-300 select-none" :style="{ backgroundColor: 'rgba(0,0,0,0.7)' }">
                            <div class="flex flex-column p-5 h-full">
