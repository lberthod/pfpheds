    ...
    <div>
        <div class="card">
            <div class="relative overflow-hidden h-20rem bg-primary flex flex-column align-items-center justify-content-center border-round mb-8">
                ...
                <IconField iconPosition="left" class="w-9 md:w-6">
                    <InputIcon class="pi pi-search" />
                    <InputText id="name" type="text" placeholder="Search" :style="{ borderRadius: '2rem' }" class="w-full" />
                </IconField>
            </div>
                ...
                <div class="col-12 md:col-4 mb-5">
                    <div class="flex flex-column align-items-center">
                        ...
                        <ul class="list-none m-0 p-0 text-center">
                            ...
                            <li class="line-height-3 mb-1">
                                <a class="text-color-secondary hover:text-primary cursor-pointer">Consectetur adipiscing elit</a>
                            </li>
