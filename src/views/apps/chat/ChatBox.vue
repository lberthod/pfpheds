...
<template>
  <div class="flex flex-col h-full relative">
    ...
    <div v-if="user && defaultUserId" class="flex items-center p-4 border-t border-gray-300">
      <button 
    ...
    <!-- Sélecteur d'Emojis -->
    <div v-if="showEmojiPicker" class="absolute bottom-20 right-4 bg-white border rounded-lg p-2 shadow-lg z-10 flex flex-wrap w-48">
      <button
