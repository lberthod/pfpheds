...
import VideoComp from './ImpactHumainComponent.vue';
import IntroComponent from './IntroComponent.vue';
import ProcessComp from './TableRondeComponent.vue';
import IACom from './IAComponent.vue';
import TableRondeComp from './DossierPatientComponent.vue';
import AproposComponent from './ConclusionComponent.vue';
