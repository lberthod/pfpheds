      ...
      <div class="container">
        ...
        <div class="row align-items-center g-5">
          ...
          <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
            ...
            <!-- Title -->
            <h1 class="mb-0 display-6">Plateforme de formation
              <span class="position-relative">pratique
                <!-- SVG START -->
...
-->
            ...
            <figure class="position-absolute bottom-0 start-50 translate-middle-x mb-n5 z-index-9">
              <svg width="800px" height="298px" viewBox="0 0 686 298">
            ...
            <div class="position-relative">
              ...
              <img class="img-batiment" src="/src/assets/images/heds/image/LBB_batiment.jpg" alt="">
             </div>
           </div>
           <!-- Right content END -->
        </div>
