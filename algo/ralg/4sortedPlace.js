...
const studentsData = JSON.parse(fs.readFileSync('updated_data.json', 'utf8'));
...
saveToJson(updatedAssignedPlaces, 'updated_places_assigned_with_place_count.json');
saveToCSV(updatedAssignedPlaces, 'updated_places_assigned_with_place_count.csv');
